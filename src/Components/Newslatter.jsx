    ...
    <section className="bg-white ">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light text-gray-500 sm:text-xl">
            Stay up to date with ExQuizIt announcements, be the first to know
            about new features and receive the best recomendations.
          </p>
          <form action="#">
            ...
            <div className="mx-auto max-w-screen-sm text-sm text-center sm:text-left text-gray-500 newsletter-form-footer">
