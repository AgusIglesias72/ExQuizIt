    ...
    <>
      <PageLayout title="ExQuizIt - Sign In" description="Sign in page">
        ...
        <div class="bg-white shadow md:my-[6rem] lg:my-28 rounded xl:w-2/5 lg:w-3/5 mx-auto md:w-2/3 w-full p-10">
          ...
          <p
            tabindex="0"
            class="focus:outline-none text-sm mt-6 font-medium leading-none text-gray-500"
          >
            ...
            {Object.values(providers).map((provider) => (
              <div key={provider.name} className="w-full">
                <button
                  ...
                  class="py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full"
                >
                  {provider.name === 'Google' && svgIcons.google}
                  {provider.name === 'GitHub' && svgIcons.github}
                  {provider.name === 'Discord' && svgIcons.discord}
                  <span class="text-base font-medium ml-4 text-gray-700">
